define(["jquery","layer","text!../str/lianxirenxinxi.html",
        "css!../css/renzhenggeren.css","css!../css/lianxirenxinxi.css",
        "css!../css/pop.css", "css!../css/layer.css"],
    function($, layer,html){
    function render(){
        $(".main").html(html);
        ...
        var data=JSON.parse(sessionStorage.getItem("lianxiren"))
        ...
        $(".goshang").on("click",function(){
          ...
          relation1s=$(".cont ul li").eq(3).find("span").eq(1).html()
            ...
            sessionStorage.setItem("lianxiren",JSON.stringify(lianxi))

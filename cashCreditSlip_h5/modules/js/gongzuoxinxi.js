define(["jquery","layer","text!../str/gongzuoxinxi.html",
        "css!../css/renzhenggeren.css","css!../css/pop.css", "css!../css/layer.css"],
    function($, layer,html){
    function render(){
        $(".main").html(html);
        ...
        var data=JSON.parse(sessionStorage.getItem("gongzuo"))
            if(data){
        ...
        $(".goshang").on("click",function(){
            ...
            sessionStorage.setItem("gongzuo",JSON.stringify(gongzuo))
